 ...
 *
 * TESTED AND VERIFIED pattern for Azure AI Agents SDK.
 * Uses @azure/ai-agents (NOT @azure/ai-projects).
 *
 * Key concepts:
 * - Agents: AI assistants with tools (code_interpreter, file_search, etc.)
 * - Threads: Conversation containers that persist messages
 * - Runs: Execute agent on a thread to generate responses
 *
 * Authentication:
 * - Uses DefaultAzureCredential (run `az login` for local dev, Managed Identity in production)
 *
 * Required RBAC:
 * - Role: "Azure AI Developer" or "Cognitive Services OpenAI Contributor"
 * - Scope: Your AI Foundry resource
 *
 * Environment Variables:
 * - AZURE_AI_FOUNDRY_ENDPOINT: Full project endpoint (e.g., https://resource.services.ai.azure.com/api/projects/project-name)
 */
...
// For production: uses Managed Identity automatically
